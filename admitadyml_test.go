...
func TestYml(t *testing.T) {
	...
	offer := Offer{
		...
		Available:            true,
		Bid:                  21,
		URL:                  "http://best.seller.ru/product/12348",
		Price:                600,
		OldPrice:             800,
		CurrencyID:           "USD",
		CategoryID:           6,
